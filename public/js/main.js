function multipleSelect(element_id) {
    ...
    var placeholder = (select.getAttribute('placeholder') != undefined) ? select.getAttribute('placeholder') : "";
...
document.addEventListener('DOMContentLoaded', function() {
    var multipleSelects = document.querySelectorAll('select[multiple]');

    multipleSelects.forEach(function(select) {
        multipleSelect(select.id);
    });
});